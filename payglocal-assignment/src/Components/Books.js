      ...
      <Popup trigger={btnTrigger}>
        ...
        <div className="filterPopup">
          <div className="filterSection">
            ...
            <button className="ratingRange" onClick={handleShowRange}>Rating Range</button>
            {showRange?(
                <div className="ratingSection">
                    <label htmlFor="Rating">Show Rating Above: </label>
                    <select className="ratingRange" value={rangeDrop} name="Rating" onChange={handleRatingRange}>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
